...
{#if decorated}
  <rect fill={scheme.mainFill} stroke="none" x=0 y=0 width={textMargin} height={height}></rect>
  <rect fill={scheme.accentFill} stroke="none" x={width-width/10} y=0 width={width/10} height={height}></rect>
  {#if height>50}
  ...
  {/if}
{:else}
  <rect class="book" fill={scheme.mainFill} stroke="none" width={width} height={height}></rect>
{/if}
