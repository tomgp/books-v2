...
<p>By <a href="author-{authorSlug(String(overViewData.authors))}">{overViewData.authors}</a>{#if overViewData.translator}. Translated by {overViewData.translator}{/if}</p>
